const categories = ['All', 'AI Tools', 'AI Agents & Automation', 'Web Hosting', 'Tutorials', 'Productivity', 'MakeMoneyWithAI']
...
const activeColors = {
  ...
  'AI Agents & Automation': 'border-amber-600 dark:border-amber-400 text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/60 font-bold shadow-sm',
